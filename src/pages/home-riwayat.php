<main>
  <section class="bg-green-primary">
    <div class="container">
      ...
      <div class="rounded-xl w-full px-6 py-2 bg-white">
        ...
        <div class="flex justify-between items-center mt-3 font-bold">
          ...
          <div class="border-r px-6 py-4">
            <button class="button-green text-red">3 hari lagi</button>
          </div>
          <div class="border-r px-6 py-4">
            <a class="text-red" href="/riwayat.php?id=1">Lebih Lanjut  ></a>
          </div>
        </div>
      </div>
    </div>
